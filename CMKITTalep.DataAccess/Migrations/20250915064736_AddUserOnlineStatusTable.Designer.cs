...
namespace CMKITTalep.DataAccess.Migrations
{
    ...
    [Migration("20250915064736_AddUserOnlineStatusTable")]
    partial class AddUserOnlineStatusTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMKITTalep.Entities.UserOnlineStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CMKITTalep.Entities.UserOnlineStatus", b =>
                {
                    b.HasOne("CMKITTalep.Entities.User", "User")
                        ...
                        .HasForeignKey("CMKITTalep.Entities.UserOnlineStatus", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
