...
namespace CMKITTalep.DataAccess.Migrations
{
    ...
    [Migration("20250912112156_MoveRequestResponseTypeToRequestResponse")]
    partial class MoveRequestResponseTypeToRequestResponse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CMKITTalep.Entities.RequestResponse", b =>
                {
                    ...
                    b.Property<int?>("RequestResponseTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RequestResponseTypeId");

                    b.ToTable("RequestResponses");
                });

            modelBuilder.Entity("CMKITTalep.Entities.RequestResponseType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RequestResponseTypes");
                });
            ...
            modelBuilder.Entity("CMKITTalep.Entities.RequestResponse", b =>
                {
                    ...
                    b.HasOne("CMKITTalep.Entities.RequestResponseType", "RequestResponseType")
                        .WithMany()
                        .HasForeignKey("RequestResponseTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Request");

                    b.Navigation("RequestResponseType");
                });
